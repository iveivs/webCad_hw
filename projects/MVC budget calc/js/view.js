...
//     elements.budgetEl.innerHTML = priceFormatter.format(budgetSummary.totalBudget);

//     elements.totalIncomeEl.innerHTML = '+ ' + priceFormatter.format(budgetSummary.totalIncome);
    
//     elements.totlaExpenseEl.innerHTML = '- ' + priceFormatter.format(budgetSummary.totalExpense);

//     if (budgetSummary.expensePercents) {
//         const html = `<div class="badge">${budgetSummary.expensePercents}%</div> `;
...
// другой вариант, через деструктуризацию
function renderBudget({totalIncome, totalExpense, expensePercents, totalBudget}) {
